...
print("CHOOSE YOUR PLAYABLE CHARACTER: ", "FOR playing as KING, PRESS 'K'", "FOR playing as QUEEN, PRESS 'Q'")
character = input("enter valid selection: ")

if(character!="k" and character!="K" and character!="Q" and character!="q"):
...
# global variable for keeping track of last direction in which the queen moved
queen_move = "d"
...
Tower1 = Wizard_Tower("Tower of God",10, 7, 23, 3, 30)
Tower2 = Wizard_Tower("25th Bam", 10, 11, 23, 3, 30)


if character=="K" or character=="k":
    MC = King("Lain", 2, 1, 9, 1000, 1)
elif character=="Q" or character=="q":
    MC = Queen("Chinatsu", 2, 1, 5, 1000, 1)
...
def archer_mover_function(x, y):
    for obj in archers:
        if(obj.health>0):
            ...
            archer_x = obj.x_coordinate
            archer_y = obj.y_coordinate
            curr_distance = 1000
            
            if(Hut1.hitpoint>0):
                new_distance = ((((archer_x - Hut1.x_coordinate)**2) + ((archer_y - Hut1.y_coordinate)**2) )**0.5)
            ...
            if(Hut2.hitpoint>0):
                new_distance = ((((archer_x - Hut2.x_coordinate)**2) + ((archer_y - Hut2.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Hut2.x_coordinate
                    y = Hut2.y_coordinate
            ...
            if(Hut3.hitpoint>0):
                new_distance = ((((archer_x - Hut3.x_coordinate)**2) + ((archer_y - Hut3.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Hut3.x_coordinate
                    y = Hut3.y_coordinate
            ...
            if(Hut4.hitpoint>0):
                new_distance = ((((archer_x - Hut4.x_coordinate)**2) + ((archer_y - Hut4.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Hut4.x_coordinate
                    y = Hut4.y_coordinate
            ...
            if(Hut5.hitpoint>0):
                new_distance = ((((archer_x - Hut5.x_coordinate)**2) + ((archer_y - Hut5.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Hut5.x_coordinate
                    y = Hut5.y_coordinate
            ...
            if(TownHall_Bound1.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound1.x_coordinate)**2) + ((archer_y - TownHall_Bound1.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound2.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound2.x_coordinate)**2) + ((archer_y - TownHall_Bound2.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound3.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound3.x_coordinate)**2) + ((archer_y - TownHall_Bound3.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound4.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound4.x_coordinate)**2) + ((archer_y - TownHall_Bound4.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound5.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound5.x_coordinate)**2) + ((archer_y - TownHall_Bound5.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound6.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound6.x_coordinate)**2) + ((archer_y - TownHall_Bound6.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound7.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound7.x_coordinate)**2) + ((archer_y - TownHall_Bound7.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound8.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound8.x_coordinate)**2) + ((archer_y - TownHall_Bound8.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound9.hitpoint>0):
                new_distance = ((((archer_x - TownHall_Bound9.x_coordinate)**2) + ((archer_y - TownHall_Bound9.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(TownHall_Bound10.hitpoint>0):  
                new_distance = ((((archer_x - TownHall_Bound10.x_coordinate)**2) + ((archer_y - TownHall_Bound10.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(Cannon1.hitpoint>0):
                new_distance = ((((archer_x - Cannon1.x_coordinate)**2) + ((archer_y - Cannon1.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(Cannon2.hitpoint>0):
                new_distance = ((((archer_x - Cannon2.x_coordinate)**2) + ((archer_y - Cannon2.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
            ...
            if(Tower1.hitpoint>0):
                new_distance = ((((archer_x - Tower1.x_coordinate)**2) + ((archer_y - Tower1.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Tower1.x_coordinate
                    y = Tower1.y_coordinate
                    br_index = -25
            
            if(Tower2.hitpoint>0):
                new_distance = ((((archer_x - Tower2.x_coordinate)**2) + ((archer_y - Tower2.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Tower2.x_coordinate
                    y = Tower2.y_coordinate
                    br_index = -26
                
            if(obj.attacking==False):
                obj.archer_moves(x, y)
    
def balloon_mover_function(x, y):
    for obj in balloons:
        if(obj.health>0):
            
            balloon_x = obj.x_coordinate
            balloon_y = obj.y_coordinate
            curr_distance = 1000
            
            if(Cannon1.hitpoint>0):
                new_distance = ((((balloon_x - Cannon1.x_coordinate)**2) + ((balloon_y - Cannon1.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Cannon1.x_coordinate
                    y = Cannon1.y_coordinate
            ...
            if(Cannon2.hitpoint>0):
                new_distance = ((((balloon_x - Cannon2.x_coordinate)**2) + ((balloon_y - Cannon2.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Cannon2.x_coordinate
                    y = Cannon2.y_coordinate
            ...
            if(Tower1.hitpoint>0):
                new_distance = ((((balloon_x - Tower1.x_coordinate)**2) + ((balloon_y - Tower1.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Tower1.x_coordinate
                    y = Tower1.y_coordinate
            ...
            if(Tower2.hitpoint>0):
                new_distance = ((((balloon_x - Tower2.x_coordinate)**2) + ((balloon_y - Tower2.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Tower2.x_coordinate
                    y = Tower2.y_coordinate
            ...
            if(Cannon1.hitpoint<=0 and Cannon2.hitpoint<=0 and Tower1.hitpoint<=0 and Tower2.hitpoint<=0):
                if(Hut1.hitpoint>0):
                    new_distance = ((((balloon_x - Hut1.x_coordinate)**2) + ((balloon_y - Hut1.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = Hut1.x_coordinate
                        y = Hut1.y_coordinate
                ...
                if(Hut2.hitpoint>0):
                    new_distance = ((((balloon_x - Hut2.x_coordinate)**2) + ((balloon_y - Hut2.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = Hut2.x_coordinate
                        y = Hut2.y_coordinate
                ...
                if(Hut3.hitpoint>0):
                    new_distance = ((((balloon_x - Hut3.x_coordinate)**2) + ((balloon_y - Hut3.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = Hut3.x_coordinate
                        y = Hut3.y_coordinate
                ...
                if(Hut4.hitpoint>0):
                    new_distance = ((((balloon_x - Hut4.x_coordinate)**2) + ((balloon_y - Hut4.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = Hut4.x_coordinate
                        y = Hut4.y_coordinate
                ...
                if(Hut5.hitpoint>0):
                    new_distance = ((((balloon_x - Hut5.x_coordinate)**2) + ((balloon_y - Hut5.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = Hut5.x_coordinate
                        y = Hut5.y_coordinate
                ...
                if(TownHall_Bound1.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound1.x_coordinate)**2) + ((balloon_y - TownHall_Bound1.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound1.x_coordinate
                        y = TownHall_Bound1.y_coordinate
                ...
                if(TownHall_Bound2.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound2.x_coordinate)**2) + ((balloon_y - TownHall_Bound2.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound2.x_coordinate
                        y = TownHall_Bound2.y_coordinate
                ...
                if(TownHall_Bound3.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound3.x_coordinate)**2) + ((balloon_y - TownHall_Bound3.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound3.x_coordinate
                        y = TownHall_Bound3.y_coordinate
                ...
                if(TownHall_Bound4.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound4.x_coordinate)**2) + ((balloon_y - TownHall_Bound4.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound4.x_coordinate
                        y = TownHall_Bound4.y_coordinate
                ...
                if(TownHall_Bound5.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound5.x_coordinate)**2) + ((balloon_y - TownHall_Bound5.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound5.x_coordinate
                        y = TownHall_Bound5.y_coordinate
                ...
                if(TownHall_Bound6.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound6.x_coordinate)**2) + ((balloon_y - TownHall_Bound6.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound6.x_coordinate
                        y = TownHall_Bound6.y_coordinate
                ...
                if(TownHall_Bound7.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound7.x_coordinate)**2) + ((balloon_y - TownHall_Bound7.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound7.x_coordinate
                        y = TownHall_Bound7.y_coordinate
                ...
                if(TownHall_Bound8.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound8.x_coordinate)**2) + ((balloon_y - TownHall_Bound8.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound8.x_coordinate
                        y = TownHall_Bound8.y_coordinate
                ...
                if(TownHall_Bound9.hitpoint>0):
                    new_distance = ((((balloon_x - TownHall_Bound9.x_coordinate)**2) + ((balloon_y - TownHall_Bound9.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound9.x_coordinate
                        y = TownHall_Bound9.y_coordinate
                ...
                if(TownHall_Bound10.hitpoint>0):  
                    new_distance = ((((balloon_x - TownHall_Bound10.x_coordinate)**2) + ((balloon_y - TownHall_Bound10.y_coordinate)**2) )**0.5)
                    if(new_distance<curr_distance):
                        curr_distance = new_distance
                        x = TownHall_Bound10.x_coordinate
                        y = TownHall_Bound10.y_coordinate
            ...
            obj.balloon_moves(x, y)
            
# def wizard_tower_attack(x,y):
#     for i in range():
#         for j in range():
...
def king_attacks(b_index):
    if(b_index==-1):
        ...
        Tower1.hitpoint = Tower1.hitpoint - MC.damage
    elif(b_index==-26):
        Tower2.hitpoint = Tower2.hitpoint - MC.damage
        
def AOE_queen(x_coord, y_coord):
    for i in range(x_coord - 5, x_coord + 5):
        if(i<=0 or i>=rows-1):
            break
        for j in range(y_coord - 10, y_coord + 10, 2):
            if(j<=1 or j>=cols-2):
                break
            if(grid[i][j]!=0):
                king_attacks(grid[i][j])
        

        
def barbarian_attacks(damage, b_index):
    if(b_index==-1):
        # hut1 has been attacked by the barbarian
        Hut1.hitpoint = Hut1.hitpoint - damage
    elif(b_index==-2) :
        # hut2 has been attacked by the barbarian
        ...
        # TOWNHALL IS UNDER ATTACK BY THE ALMIGHTY barbarian
        ...
        Tower1.hitpoint = Tower1.hitpoint - damage
    elif(b_index==-26):
        Tower2.hitpoint = Tower2.hitpoint - damage
        ...
        for i in range(rows):
            ...
            for j in range(cols):
                if grid[i][j] == 1 :
                    ...
                    # Archers
                    flag = 0
                    if archer_exists == True:
                        for obj in archers:
                            if i==obj.x_coordinate and j==obj.y_coordinate and obj.health>0 :
                                if obj.health>=50:
                                    print(f"{Fore.LIGHTBLACK_EX + Style.BRIGHT + Back.GREEN}A", end="")
                                elif obj.health>=20 and obj.health>=50:
                                    print(f"{Fore.LIGHTBLACK_EX + Style.NORMAL + Back.YELLOW}A", end="")
                                else :
                                    print(f"{Fore.LIGHTBLACK_EX + Style.DIM + Back.RED}A", end="")
                                grid[i][j] = 51
                                # 51 also indicates ARCHERS
                                flag = 1
                                range_flag = 0
                                # logic for canon like attacking for the archers
                                for ii in range(obj.x_coordinate-obj.range, obj.x_coordinate+obj.range):
                                    if ii<=0 or ii>=rows:
                                        break
                                    for jj in range(obj.y_coordinate-(2*obj.range), obj.y_coordinate+(2*obj.range), 2):
                                        if jj<=1 or jj>=cols:
                                            break
                                        if grid[ii][jj]<=-1 and grid[ii][jj]>=-22:
                                            range_flag = 1
                                            barbarian_attacks(obj.damage, grid[ii][jj])
                                if range_flag==1:
                                    obj.attacking = True
                                else:
                                    obj.attacking = False
                    ...
                    # TOWERS
                    elif i==Tower1.x_coordinate and j==Tower1.y_coordinate and Tower1.hitpoint>0 :
                        grid[i][j] = -25
                        if Tower1.hitpoint>=5:
                            print(f"{Back.GREEN}W", end="")
                        elif Tower1.hitpoint>=2 and Tower1.hitpoint<5 :
                            print(f"{Back.YELLOW}W", end="")
                        else :
                            print(f"{Back.RED}W", end="")
                    elif i==Tower2.x_coordinate and j==Tower2.y_coordinate and Tower2.hitpoint>0 :
                        grid[i][j] = -26
                        if Tower2.hitpoint>=5:
                            print(f"{Back.GREEN}W", end="")
                        elif Tower2.hitpoint>=2 and Tower2.hitpoint<5 :
                            print(f"{Back.YELLOW}W", end="")
                        else :
                            print(f"{Back.RED}W", end="")
                        ...
                        if(MC.name=="Lain"):
                            ...
                            print(f"{Fore.CYAN + Style.BRIGHT + Back.MAGENTA}Q", end="")
                        grid[i][j] = 50
                    else :
                        grid[i][j] = 0
                        # grid cell is empty
                        ...
                        for obj in balloons:
                            if i==obj.x_coordinate and j==obj.y_coordinate and obj.health>0 :
                                if obj.health>=50:
                                    ...
                                    print(f"{Fore.LIGHTBLACK_EX + Style.DIM + Back.RED}b", end="")
                                # grid[i][j] = 51
                                # since BALLOONS are aerial, they never actually occupy the grid
                                # might have to hover balloon on top of building
                                flag = 1
                                if(obj.y_coordinate!=(cols-2) and grid[obj.x_coordinate][obj.y_coordinate]!=0):
                                    barbarian_attacks(obj.damage, grid[obj.x_coordinate][obj.y_coordinate])
                                elif(obj.y_coordinate!=1 and grid[obj.x_coordinate][obj.y_coordinate]!=0):
                                    barbarian_attacks(obj.damage, grid[obj.x_coordinate][obj.y_coordinate])
                                elif(obj.x_coordinate!=(rows-1) and grid[obj.x_coordinate][obj.y_coordinate]!=0):
                                    barbarian_attacks(obj.damage, grid[obj.x_coordinate][obj.y_coordinate])
                                elif(obj.x_coordinate!=0 and grid[obj.x_coordinate][obj.y_coordinate]!=0):
                                    barbarian_attacks(obj.damage, grid[obj.x_coordinate][obj.y_coordinate])
                                break
                    if(flag==1):
                        continue
...
archer_exists = False
balloon_exists = False

path = "replays"

f = open(os.path.join(path, 'replay.txt'), 'w')
f.write("")
f.close()

replay_file = open(os.path.join(path, 'replay.txt'), 'a')
t0=time.time()
...
while (value):
    ...
    show_village()
    MC.show_Health(MC.health/10, 100, "Current Health")
    key_val = input_to()
    if(key_val=="q"):
    ...
    # add wizard towers attack here too
    ...
    if(MC.health>0) :
        ...
        # Archers
            ...
            if(len(archers)<limit_on_archers):
                replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
                archer_exists = True
                archers.append(Archer("EmiyaShirou", 1, 3, 5, 100, 1, 5, False))
            # os.system('clear')
            # print("VICTORY!")
            # time.sleep(5)
        elif key_val=="k" :
            if(len(archers)<limit_on_archers):
                replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
                archer_exists = True
                archers.append(Archer("EmiyaShirou", 7, 3, 5, 100, 1, 5, False))
        elif key_val=="n" :
            if(len(archers)<limit_on_archers):
                replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
                archer_exists = True
                archers.append(Archer("EmiyaShirou", 13, 3, 5, 100, 1, 5, False))
                
        # Balloons
        elif key_val=="i" :
            if(len(balloons)<limit_on_balloons):
                replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
                balloon_exists = True
                balloons.append(Balloon("FunnyValentine", 1, 3, 10, 100, 1))
            # os.system('clear')
            # print("VICTORY!")
            # time.sleep(5)
        elif key_val=="j" :
            if(len(balloons)<limit_on_balloons):
                replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
                balloon_exists = True
                balloons.append(Balloon("FunnyValentine", 7, 3, 10, 100, 1))
        elif key_val=="b" :
            if(len(balloons)<limit_on_balloons):
                replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
                balloon_exists = True
                balloons.append(Balloon("FunnyValentine", 13, 3, 10, 100, 1))
                
        elif key_val==" " and MC.name=="Lain" :
            replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
        ...
        # AoE for the Queen
        # might need to look for some errors here
        elif key_val==" " and MC.name=="Chinatsu" :
            replay_file.write(key_val+" "+str(time.time()-t0)+"\n")
            if(queen_move=="w"):
                if((MC.x_coordinate-8)>0):
                    x_coord = MC.x_coordinate - 8
                    y_coord = MC.y_coordinate
                    AOE_queen(x_coord, y_coord)
            elif(queen_move=="s"):
                if((MC.x_coordinate+8)<rows):
                    x_coord = MC.x_coordinate + 8
                    y_coord = MC.y_coordinate
                    AOE_queen(x_coord, y_coord)
            elif(queen_move=="a"):
                if((MC.x_coordinate-16)>1):
                    x_coord = MC.x_coordinate
                    y_coord = MC.y_coordinate - 16
                    AOE_queen(x_coord, y_coord)
            elif(queen_move=="d"):
                if((MC.x_coordinate+16)<cols-2):
                    x_coord = MC.x_coordinate
                    y_coord = MC.y_coordinate + 16
                    AOE_queen(x_coord, y_coord)
    ...
    for obj in troops:
        if(obj.health>0):
            ...
            if(Cannon2.hitpoint>0 and obj.x_coordinate>=(Cannon2.x_coordinate-Cannon2.range) and obj.x_coordinate<=(Cannon2.x_coordinate+Cannon2.range) and obj.y_coordinate>=(Cannon2.y_coordinate-(2*Cannon2.range)) and obj.y_coordinate<=(Cannon2.y_coordinate+(2*Cannon2.range))) :
                obj.health = obj.health - Cannon2.damage_value
            # how do i add the wizard tower attack
            ...
            if(Tower1.hitpoint>0):
                new_distance = ((((barbarian_x - Tower1.x_coordinate)**2) + ((barbarian_y - Tower1.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Tower1.x_coordinate
                    y = Tower1.y_coordinate
            ...
            if(Tower2.hitpoint>0):
                new_distance = ((((barbarian_x - Tower2.x_coordinate)**2) + ((barbarian_y - Tower2.y_coordinate)**2) )**0.5)
                if(new_distance<curr_distance):
                    curr_distance = new_distance
                    x = Tower2.x_coordinate
                    y = Tower2.y_coordinate
    ...
    archer_mover_function(0,0)
    archer_mover_function(0,0)
    balloon_mover_function(0,0)
    balloon_mover_function(0,0)
    ...
    for i in range(rows):
        for j in range(cols):
            if (grid[i][j]<=-21 and grid[i][j]>=-28) or (grid[i][j] <=-1 and grid[i][j] >=-6):
                test_var = 1
                break
        if(test_var==1):
            break
...
replay_file.close()
            ...
            # archer moves twice as in it has twice the speed as barbarian
...
#     # attributes of your highness
#     damage = 10
#     health = 100
#     movement_speed = 2

#     # methods for movement and attacking
...
#     # spawned from the spawning point

# class Spells:
#     # rage spell doubles damage and movement speed of the king and his troops/barbarians
#     # Heal spell affects every troop and king, increses health to 150% of current health(basically add 1/2 of current health to current health.)
#     My_soldiers = "Rage"
